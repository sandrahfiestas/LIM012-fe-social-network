  ...
  viewSignUp.innerHTML = `
    ...
    <div class="register-container">
        <div class="register-container register">
            ...
            <button class="" id="btnprueba">Prueba de validación</button>
...
const emailLogUpDos = viewSignUp.querySelector('#emailSignUp');
//const valido = viewSignUp.querySelector('#msgEmail');

      emailLogUpDos.addEventListener('keyPress', () => {
      const campo = event.target;
      const patronEmail = /[A-Za-z]+@[a-z]+\.[a-z]+/ ;

      if (patronEmail.test(campo.value)) {
        emailLogUpDos.classList.remove('invalid')
        //valido.classList.remove('msgInvalid')

      } else {
        emailLogUpDos.classList.add('invalid');
        emailLogUpDos.focus();
        //valido.classList.add('msgInvalid');
        //valido.innerHTML = campo.value + " * Email invalido";
      }
  });
